...
import com.ibaguo.nlp.dependency.MaxEntDependencyParser;
import com.ibaguo.nlp.dictionary.py.Pinyin;
import com.ibaguo.nlp.dictionary.py.PinyinDictionary;
import com.ibaguo.nlp.dictionary.ts.SimplifiedChineseDictionary;
import com.ibaguo.nlp.dictionary.ts.TraditionalChineseDictionary;
import com.ibaguo.nlp.phrase.IPhraseExtractor;
import com.ibaguo.nlp.phrase.MutualInformationEntropyPhraseExtractor;
import com.ibaguo.nlp.seg.Segment;
import com.ibaguo.nlp.seg.Viterbi.ViterbiSegment;
import com.ibaguo.nlp.seg.common.Term;
import com.ibaguo.nlp.summary.TextRankKeyword;
import com.ibaguo.nlp.summary.TextRankSentence;
...
public class MyNLP
{
    ...
    private MyNLP() {} //make it static outside
    ...
    {
        return new ViterbiSegment();   // Viterbi Segment is the best seg in both performance and acc by far
    }
