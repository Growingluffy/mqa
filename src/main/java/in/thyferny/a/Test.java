...
//		trainSaveMaxEnt();
		...
		System.out.println("距离0\t" + CoreSynonymDictionary.distance("香蕉", "苹果"));
		System.out.println("距离1\t" + CoreSynonymDictionary.distance("香蕉", "梨"));
		System.out.println("距离2\t" + CoreSynonymDictionary.distance("病痛", "痢疾"));
		...
		System.out.println("距离X\t" + CoreSynonymDictionary.distance("香蕉", "橙汁"));
	}
    ...
    public static void loadPredictMaxEnt() throws IOException
    {
        ...
        fieldList.add("When");
        fieldList.add("was");
        Pair<String, Double>[] result = maxEnt.predict(fieldList);  // 棰勬祴QuestionType姒傜巼鍚勬槸澶氬皯
